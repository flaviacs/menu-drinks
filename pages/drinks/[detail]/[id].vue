...
<template>
  ...
  <div v-if="pending" class="p-4">
    <div class="w-full md:w-9/12 m-auto text-center">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py md:py-9">
        <div class="min-h-300 md:h-full bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100"></div>
        <div>
          <div class="h-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100 mb-5"></div>
          <div class="h-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100 mb-5"></div>
          <div class="h-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100 mb-5"></div>
          <div class="h-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100 mb-5"></div>
          <div class="h-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md ease-in duration-100 mb-5"></div>
  ...
  <div v-else v-if="error" class="p-4">
    <div class="w-full md:w-9/12 m-auto text-center">
      <p>{{ drinks?.statusMessage }}</p>error
    </div>
  </div>
